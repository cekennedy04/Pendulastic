...
- **Dependencies:** U1.
- **Files:** `mobile-imu-core/src/goniometry.rs`, `mobile-imu-core/src/scoring.rs`, `mobile-imu-core/tests/scoring_test.rs`.
...
- **Verification:** `cargo test` passes; fixture comparison against Python `score_waveform` output is within tolerance.
