...
----------------------------------------------------
1. CLINICAL MAS for that leg, when one has been recorded. Always wins.
2. CONTROL by diagnosis -> non-spastic. Unaffected controls are not assessed
   with MAS, but they are non-spastic by recruitment.
3. A0-DERIVED from the OptiTrack pendulum swing, for a diagnosed participant
   with no MAS yet. This is the stopgap until MAS is collected -- currently
   7 of 21 participants have no MAS at all, including all four post-stroke
   participants.
4. UNKNOWN. Never silently dropped, never guessed. An unknown leg is reported
