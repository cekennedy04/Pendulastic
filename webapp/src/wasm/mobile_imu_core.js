/* @ts-self-types="./mobile_imu_core.d.ts" */
...
export class WasmSession {
     ...
     */
    calm_s() {
        const ret = wasm.wasmsession_calm_s(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {number}
     */
    drift_deg() {
        const ret = wasm.wasmsession_drift_deg(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     */
    finish() {
        const ret = wasm.wasmsession_finish(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
    ...
    /**
     * @param {number} beta
     * @param {number} ema_alpha
     */
    constructor(beta, ema_alpha) {
        const ret = wasm.wasmsession_new(beta, ema_alpha);
        this.__wbg_ptr = ret;
    ...
    push_batch(buf) {
        ...
        wasm.wasmsession_push_batch(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @returns {number}
     */
    sample_count() {
        const ret = wasm.wasmsession_sample_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    state_code() {
        const ret = wasm.wasmsession_state_code(this.__wbg_ptr);
        return ret;
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('mobile_imu_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
